...
//    const CARD_CONNECT_URL      = 'fts.cardconnect.com:6443';
...
//    const CARD_CONNECT_PASS     = 'testing123';
	...
	*/
	...
	private function send($endpoint, $operation, $request) {
		...
		//var_dump($pest); die;
		$response = "";
		//var_dump($request); die; //TODO CPM this try catch is where it is failing. need to get on customer support with card connect
