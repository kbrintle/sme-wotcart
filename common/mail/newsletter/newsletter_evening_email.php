...
<style>
    ...
    .img-container3{
        background-image: url("<?= Yii::$app->params['base_url'].'/uploads/email/photos/bedhead.png';?>");
        height:125px;
        width:125px;
        background-size: cover;
        background-position: center center;
...
<div class="gutter">
    <div class="gutter outer-container">
        ...
        <img src="<?= Yii::$app->params['base_url'].'/uploads/email/photos/Shot_17_070215_039-mask-25.png';?>" alt="" style="width:100%;"/>
        <div class="main-container" style="margin-top:-3px;">
            <div class="smaller-gutter">
                <div style="text-align: center;">
                    <h2 class="navy">
                        Fall Asleep With Our Curated <br> Playlist On Spotify
                    </h2>
                    ...
                    <div style="border-left: 2px solid #F5F7F8; border-right: 2px solid #F5F7F8; border-bottom: 2px solid #F5F7F8;  text-align: left; padding:50px;">
                        <img src="<?= Yii::$app->params['base_url'].'/uploads/email/photos/bedhead.png';?>" alt="" style="max-width:50%;"/>
                    </div>
                    <div class="padding">
                        ...
                        <h2 class="navy">
                            7 Ways To Spend More<br> Productive Time In Bed
                        </h2>
                    </div>
                </div>
            </div>
            <img src="<?= Yii::$app->params['base_url'].'/uploads/email/photos/welcome-nozip.png';?>" alt="" style="width:100%;"/>
            ...
            <div class="smaller-gutter">
                <div style="text-align: center;">
                    ...
                    <div  style="border-top:solid 3px #F5F7F8;" class="padding">
                        ...
                        <h2 class="navy">
                            Forget Your Plans And Stay In <br>Bed All Weekend
                        </h2>
                    </div>

                </div>
            </div>
            <img src="<?= Yii::$app->params['base_url'].'/uploads/email/photos/Memory%20Foam%20-%20the%20Best%20Pillow%20for%20a%20Good%20Night\'s%20Sleep.jpg';?>" alt="" style="width:100%;"/>
