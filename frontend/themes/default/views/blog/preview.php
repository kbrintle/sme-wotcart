        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="/admin/blog/update/<?= $post->post_id; ?>">Back to Edit</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="img-caption">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <!-- @TODO put tags here
                    <span class="pull-right">iComfort Dog Bed</span> !-->
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="social-share">
                    ...
                    <a href="https://www.instagram.com/americas.mattress/" target="_blank" class="btn btn-ig">Follow on Instagram</a>


                    <div class="blg-newsletter">
