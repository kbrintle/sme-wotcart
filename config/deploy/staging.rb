...
set :deploy_to, '/home/americasmattress/amr.dev.wideopentech.com'
...
server 'fm.dev.wideopentech.com',
  user: 'root',
  password: 'W1d30p3n!$'

parms = {
   text: "Starting deployment of branch:develop to staging server INSERT_DESTINATION_HERE",
   channel: "@pateason",
   username: "Mattress-Bot",
 }
...
task :complete_deployment do
    on roles(:all) do
        within release_path do
            ...
            info "Deployment to Staging server completed"
            parms = {
