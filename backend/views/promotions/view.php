...
$this->title = $model->id;
//$this->params['breadcrumbs'][] = ['label' => 'Promotion Codes', 'url' => ['index']];
//$this->params['breadcrumbs'][] = $this->title;
?>

<?php $form = ActiveForm::begin(); ?>
    <div class="container-fluid pad-xs">
        <div class="promotion-code-view">
            <div class="row action-row">
                <div class="col-md-12">
                    ...
                    <?= Html::a( '<i class="glyphicon glyphicon-arrow-left"></i>', Url::to(['promotions/index']), ['title' => 'Back', 'class' => 'btn btn-secondary pull-left']); ?>
                </div>
            </div>
