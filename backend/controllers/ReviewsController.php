...
use common\models\catalog\search\CatalogProductReviewSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReviewsController implements the CRUD actions for CatalogProductReview model.
 */
class ReviewsController extends Controller
{
    ...
    /**
     * Lists all CatalogProductReview models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CatalogProductReviewSearch();
    ...
    /**
     * Displays a single CatalogProductReview model.
     * @param integer $id
     * @return mixed
     */
